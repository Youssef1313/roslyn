...
{
    internal abstract class AbstractFileHeaderDiagnosticAnalyzer : AbstractBuiltInCodeStyleDiagnosticAnalyzerWithOption
    {
        ...
        private void HandleSyntaxTree(IDESyntaxTreeAnalysisContext context)
        {
