...
{
    internal abstract class AbstractUseInferredMemberNameDiagnosticAnalyzer : AbstractBuiltInCodeStyleDiagnosticAnalyzerWithOption
    {
        protected abstract void AnalyzeSyntax(IDESyntaxNodeAnalysisContext context);
