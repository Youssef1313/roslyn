...
{
    internal abstract partial class AbstractBuiltInCodeStyleDiagnosticAnalyzerWithOption : AbstractBuiltInCodeStyleDiagnosticAnalyzer
    {
        /// <summary>
        ...
        protected AbstractBuiltInCodeStyleDiagnosticAnalyzerWithOption(
            string diagnosticId,
            ...
            : base(diagnosticId, enforceOnBuild, title, messageFormat, isUnnecessary, configurable)
        {
            RoslynDebug.Assert(option is not null);
        ...
        /// </summary>
        protected AbstractBuiltInCodeStyleDiagnosticAnalyzerWithOption(ImmutableDictionary<DiagnosticDescriptor, IOption2> supportedDiagnosticsWithOptions)
