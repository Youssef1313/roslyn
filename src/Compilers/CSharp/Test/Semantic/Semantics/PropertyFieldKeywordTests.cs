...
");
       ...
       [Fact]
        public void SpeculativeSemanticModel_FieldInRegularAccessor_LocalFunction_BindOriginalFirst()
        {
            var comp = CreateCompilation(@"
class C
{
...
");
        ...
        [Fact]
        public void SpeculativeSemanticModel_FieldInRegularAccessor_LocalFunction_BindSpeculatedFirst()
        {
            var comp = CreateCompilation(@"
class C
{
...
class C
{
    public int P
    {
        ...
        [Fact]
        public void SpeculativeSemanticModel_FieldKeywordInRegularAccessor_ReplaceBlock_LocalFunction_BindOriginalFirst()
        {
            var comp = CreateCompilation(@"
class C
{
...
class C
{
    public int P
    {
        ...
        [Fact]
        public void SpeculativeSemanticModel_FieldKeywordInRegularAccessor_ReplaceBlock_LocalFunction_BindSpeculatedFirst()
        {
            var comp = CreateCompilation(@"
class C
{
