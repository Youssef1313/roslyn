...
namespace Microsoft.CodeAnalysis.CSharp.Syntax
{
    ...
    public sealed partial class ClassDeclarationSyntax : TypeDeclarationSyntax
    {
        ...
        public override SyntaxToken OpenBraceToken => new SyntaxToken(this, ((Syntax.InternalSyntax.ClassDeclarationSyntax)this.Green).openBraceToken, GetChildPosition(8), GetChildIndex(8));
        ...
        public override SyntaxToken CloseBraceToken => new SyntaxToken(this, ((Syntax.InternalSyntax.ClassDeclarationSyntax)this.Green).closeBraceToken, GetChildPosition(10), GetChildIndex(10));
    ...
    public sealed partial class StructDeclarationSyntax : TypeDeclarationSyntax
    {
        ...
        public override SyntaxToken OpenBraceToken => new SyntaxToken(this, ((Syntax.InternalSyntax.StructDeclarationSyntax)this.Green).openBraceToken, GetChildPosition(8), GetChildIndex(8));

        public override SyntaxList<MemberDeclarationSyntax> Members => new SyntaxList<MemberDeclarationSyntax>(GetRed(ref this.members, 9));

        public override SyntaxToken CloseBraceToken => new SyntaxToken(this, ((Syntax.InternalSyntax.StructDeclarationSyntax)this.Green).closeBraceToken, GetChildPosition(10), GetChildIndex(10));
